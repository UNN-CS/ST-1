...
TEST(checkPrimeTestJV, 1isFalse) {
    EXPECT_FALSE(checkPrime(1));
  }

TEST(checkPrimeTestJV, 2isTrue) {
...
TEST(checkPrimeTestJV, BigPrimeIsTrue) {
    EXPECT_TRUE(checkPrime(11117));
  }

TEST(nPrimeTestJV, ZeroThrow) {
...
TEST(nextPrimeTestJV, zeroTest) {
    EXPECT_EQ(nextPrime(0), 2);
  }

TEST(nextPrimeTestJV, firstNumTest) {
    EXPECT_EQ(nextPrime(1), 2);
  }

TEST(nextPrimeTestJV, exactHitNumTest) {
...
TEST(sumPrimeTestJV, zeroTest) {
    EXPECT_EQ(sumPrime(0), 0);
  }

TEST(sumPrimeTestJV, firstNumTest) {
    EXPECT_EQ(sumPrime(1), 0);
  }

TEST(sumPrimeTestJV, exactHitNumTest) {
    EXPECT_EQ(sumPrime(5), 5);
  }

TEST(sumPrimeTestJV, oneNumTest) {
    EXPECT_EQ(sumPrime(3), 2);
  }

TEST(sumPrimeTestJV, bigSumTest) {
    EXPECT_NO_THROW(sumPrime(9999));
  }
